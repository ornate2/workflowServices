		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#poformdataworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"poformdataworkflowuimodule-display": {
								"semanticObject": "poformdataworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=poformdata.workflowuimodule",
									"url": sap.ui.require.toUrl("poformdata/workflowuimodule")
								}
							}
						}
					}
